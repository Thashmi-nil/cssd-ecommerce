...
import SidebarC from '../../customer/cus_sidebar/Sidebar'
import SidebarS from '../../seller/sell_sidebar/Sidebar'
    ...
    return (
        <div>
            <div className='main-container'>
                {`${userLevelData.userLevel}` == 'Owner' ? <SidebarC /> : null}

                {`${userLevelData.userLevel}` == 'Admin' ? <SidebarS /> : null}
